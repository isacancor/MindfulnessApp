...
def cuestionario_list(request, programa_id):
    ...
    if request.method == 'GET':
        ...
        if not request.user.has_role('investigador'):
            return Response(
...
def cuestionario_detail(request, cuestionario_id):
    ...
    if request.method == 'GET':
        ...
        # Verificar que el programa está en borrador
        if cuestionario.programa.estado != 'borrador':
            return Response(
...
def respuesta_list(request, cuestionario_id):
    ...
    if request.method == 'GET':
        ...
        if request.user.has_role('investigador'):
...
def respuesta_detail(request, respuesta_id):
    ...
    # Verificar permisos
    if not request.user.has_role('investigador') and respuesta.usuario != request.user:
        return Response(
