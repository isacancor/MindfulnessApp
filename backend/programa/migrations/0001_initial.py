    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_evaluacion', models.CharField(choices=[('cuestionarios', 'Cuestionarios Pre/Post'), ('diarios', 'Diarios de Autoevaluación'), ('ambos', 'Cuestionarios y Diarios'), ('ninguno', 'Sin Evaluaciones')], default='ambos', max_length=20)),
