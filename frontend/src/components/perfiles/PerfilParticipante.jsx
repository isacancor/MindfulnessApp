    ...
    return (
        <BackgroundVideo videoSrc="/videos/lluvia.mp4">
            <div className="h-screen overflow-y-auto">
                <div className="min-h-screen bg-gradient-to-bl from-indigo-950 via-sky-800 to-blue-900 py-4 md:py-8">
                    <div className="max-w-4xl mx-auto px-4 md:px-6">
                        <div className="bg-white/5 backdrop-blur-xl rounded-2xl overflow-hidden shadow-xl border border-white/10">
                            ...
                            <div className="bg-gradient-to-r from-blue-500/20 via-sky-500/20 to-indigo-500/20 p-[2px] rounded-t-2xl">
                                <div className="bg-white/10 backdrop-blur-xl p-6 md:p-8 relative">
                                    ...
                                    <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 ml-0 md:ml-10 mt-8 md:mt-0">
                                        ...
                                        <div className="text-center md:text-left">
                                            <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-white via-indigo-200 to-indigo-400 bg-clip-text text-transparent">{getDisplayName()}</h1>
                                            <p className="text-indigo-200 font-medium">Participante</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                                    <div className="bg-white/10 backdrop-blur-xl p-4 md:p-6 rounded-xl shadow-sm border border-white/10">
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <p className="text-sm text-indigo-200">Correo electrónico</p>
                                                <p className="text-white font-medium">{user.email || 'No disponible'}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-indigo-200">Teléfono</p>
                                                <p className="text-white font-medium">{user.telefono || 'No disponible'}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-indigo-200">Ubicación</p>
                                    ...
                                    <div className="bg-white/10 backdrop-blur-xl p-4 md:p-6 rounded-xl shadow-sm border border-white/10">
                                        <h3 className="text-base md:text-lg font-semibold text-white mb-4 flex items-center">
                                            <BookOpen className="h-5 w-5 text-indigo-300 mr-2" />
                                            Información Académica
                                        </h3>
                                        <div className="space-y-4">
                                            <div>
                                                <p className="text-sm text-indigo-200">Nivel Educativo</p>
                                                <p className="text-white font-medium">{formatNivelEducativo(user.nivelEducativo)}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-indigo-200">Ocupación</p>
                                                <p className="text-white font-medium">{user.ocupacion || 'No especificada'}</p>
                                            </div>
                                            <div>
                                                <p className="text-sm text-indigo-200">Experiencia en Mindfulness</p>
                    ...
                    {isDeleteModalOpen && (
                        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
                            <div className="bg-gradient-to-br from-indigo-950 via-sky-800 to-blue-900 rounded-xl p-6 max-w-md w-full mx-4 border border-white/10">
