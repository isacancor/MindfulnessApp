...
import { User, Mail, Calendar, Phone, CheckCircle, Clock, Users, XCircle } from 'lucide-react';
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between">
                                                ...
                                                {inscripciones[participante.perfil_participante.id] && (() => {
                                                    const estado = inscripciones[participante.perfil_participante.id].estado_inscripcion;
